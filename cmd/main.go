...
func main() {
	...
	e.GET("/logs/:id/get_attendances", handlers.GetLogAttendances, handlers.IsLoggedIn, handlers.OnlyAdminAccountantClerkTeacher)
	e.PUT("/logs/:log_id/log_attendances/:id/toggle", handlers.ToggleLogAttendance, handlers.IsLoggedIn)
	...
	e.DELETE("/standards/:standard_id/subjects/:subject_id/chapters/:id", handlers.DeleteChapter, handlers.IsLoggedIn, handlers.OnlyAdmin)
	...
	e.GET("/batch-standards/:id/subjects/:subject_id/chapters", handlers.GetBatchStandardSubjectChapters, handlers.IsLoggedIn)
	...
	e.DELETE("/hostels/:hostel_id/hostel_rooms/:id", handlers.DeleteHostelRoom, handlers.IsLoggedIn, handlers.OnlyAdmin)
	...
	e.PUT("/exams/:id", handlers.UpdateExam, handlers.IsLoggedIn, handlers.OnlyAdminAccountantClerkTeacher)
